...
- [ ] Task 1: Add custom-command launch-plan API
...
- [ ] Task 2: Parse sandbox-exec CLI without changing JSON mode
...
- [ ] Task 3: Generate plan in restricted child
...
- [ ] Task 4: Execute plan with exact process semantics
...
- [ ] Task 5: Verify isolation and automation behavior
...
- [ ] Task 6: Document CLI, then run full gate
